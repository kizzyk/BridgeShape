...
def parse_args():
    ...
    parser.add_argument("--test_start_epoch", type=int,default=50, help="test_start_epoch")
    ...
    parser.add_argument("--test_all", type=bool, default=False, help="test_all")
    ...
    parser.add_argument( ####gpus   "multi"
        "--distribution_type",
        default="single",

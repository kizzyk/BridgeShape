...
log_df='False'
representation='tsdf'
#ckpt="/workspace/P2P/logs_home_32/vqvae-ControlledEPNDataset_32-03001627table-all-res32-LR1e-4-T3.0-release/ckpt/vqvae_steps-30000.pth"
###########################
...
note="release"
name="${model}-${dataset_mode}-${class_id}table-${cat}-res${res}-LR${lr}-T${trunc_thres}-${note}"

...
### display & log stuff ###
display_freq=500000 # default: display_current_results
print_freq=2000 # default: print_current_errors
total_iters=500000 #100000000
save_steps_freq=2000 #print_current_metrics
###########################
...
note="release"
name="${model}-${dataset_mode}-${class_id}boat-${cat}-res${res}-LR${lr}-T${trunc_thres}-${note}"
